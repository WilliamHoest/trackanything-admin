...
CREATE TABLE brands (
    ...
    name TEXT NOT NULL,
    scrape_in_progress BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE mentions (
    ...
    brand_id BIGINT NOT NULL REFERENCES brands(id) ON DELETE CASCADE,
    topic_id BIGINT NOT NULL REFERENCES topics(id) ON DELETE CASCADE,
    primary_keyword_id BIGINT REFERENCES keywords(id),
    read_status BOOLEAN DEFAULT FALSE,
    notified_status BOOLEAN DEFAULT FALSE,
    created_at TIMESTAMPTZ DEFAULT NOW()
);

-- Create mention_keywords junction table
...
CREATE INDEX idx_brands_scrape_in_progress ON brands(scrape_in_progress);
CREATE INDEX idx_brands_scrape_started_at ON brands(scrape_started_at);
...
CREATE INDEX idx_mentions_primary_keyword_id ON mentions(primary_keyword_id);
...
CREATE INDEX idx_mention_keywords_mention_id ON mention_keywords(mention_id);
CREATE INDEX idx_mention_keywords_keyword_id ON mention_keywords(keyword_id);
...
-- RLS Policies for mention_keywords
